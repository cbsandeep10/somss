...
<div class='row'>
<div class='form-group'>
      <label class='control-label col-md-32' for='main_advisor'>Please sign here <i>(If you don't see the chair comments, then student might not have the approved advisory committee OR the committee has not approved the iPOS yet.)</i></label>
    <table id='permanent_adv'>
       <thead>
        ...
        <tr class='signature'>
           ...
           <td> <input  class='date' type='date' size='30' value='$dt' readonly></td>
        </tr>
    </tbody>
</table>
</div>
