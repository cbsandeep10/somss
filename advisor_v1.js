...
console.log("hii");
console.log('Hello' + Asu_id);
//NEW flag=main_advisor_check();
flag = true;

var Student_rating=$("input:radio[name='student_rating']:checked").val();
//NEW var Temporary_advisors=$("input:radio[name='temporary_advisors']:checked").val();
//NEW var Temp_advisor_name=$('#temp_advisor_name').val();
//NEW var Permanent_advisor=$("input:radio[name='permanent_advisor']:checked").val();
var Advisor_comments=$('#advisor_comments').val();	//comments for graduate co-ordinator
...
alert('ASU ID: ' + Asu_id + ", rating: " + Student_rating + ", advisor_comments: " + Advisor_comments + ", chair_comments: " + Chair_comments + ", advisor_owner: " + AdvisorOwner + ", sign: " + Signature);
