...
<html lang="en">
  ...
  <script src="//code.jquery.com/jquery-1.10.2.js"></script>
  <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
  <script src="./advisor_v1.js"></script>
...
<script>
var Asu_id = <?php echo $ASU_ID= $_POST['ASU_ID']; ?>;
var Index = <?php echo $INDEX= $_POST['index']; ?>;
</script>
...
{
  if($_POST['password']=='1qazXsw2' || $_POST['index']==sizeof(json_decode($row['Advisor_Mail'],true))){
//$temp='';
...
//NEW $MAIN_ADVISOR=$row['Admin_Advisor'];
$FORM_ID=19*$ASU_ID;
...
$VALID=$POS[$INDEX];	//Postion of the Advising member accessing this page	
...
<tr><th>Student iPOS/Transcript</th><td><a href='uploads/$ASU_ID-StudentiPOS'>Click Here</a></td></tr>
